 ...
 ** http://wustl.probablydavid.com/publications/IROS2014.pdf[PDF], https://blog.csdn.net/xmy306538517/article/details/72899667[中文翻译] (poor quality), https://zhuanlan.zhihu.com/p/28162685[ROS costmap_2D理解]
 ...
 ** ([red]#new!#)Lu, David Vincent, "*_Contextualized Robot Navigation_*" (2014). Engineering and Applied Science Theses & Dissertations. 62. 
    * type:pdf, https://openscholarship.wustl.edu/cgi/viewcontent.cgi?article=1062&context=eng_etds[link], https://www.mobt3ath.com/uplode/book/book-2423.pdf[link2]
...
. ([red]#new!#) 专栏文章：ROS激光SLAM导航(`move_base`参数配置注释), type: blog, https://blog.csdn.net/luohuiwu/column/info/40494[link]

...
** https://ai.google/research/pubs/pub45466.pdf[**paper**],  https://github.com/googlecartographer/cartographer[**code**],
https://github.com/googlecartographer/cartographer_ros[**code(ROS)**], https://google-cartographer.readthedocs.io/en/latest/index.html[**document(online)**],
https://media.readthedocs.org/pdf/google-cartographer-ros/latest/google-cartographer-ros.pdf[**document(pdf)**]

** https://blog.csdn.net/luohuiwu/article/details/88890307[Chinese translation]

...
** Kaiyu Zheng, https://github.com/zkytony/ROSNavigationGuide/blob/master/main.pdf[*_ROS Navigation Tuning Guide_*]. arXiv preprint arXiv:1706.09068v2, Sep. 2016. +
*** https://github.com/zkytony/ROSNavigationGuide/blob/master/main.pdf[pdf], https://github.com/teddyluo/ROSNavGuide-Chinese[*中文翻译*], http://wiki.ros.org/navigation/Tutorials/Navigation%20Tuning%20Guide[ROS Wiki]

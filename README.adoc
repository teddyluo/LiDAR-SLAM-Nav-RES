...
** https://blog.csdn.net/zong596568821xp/article/details/77934688[*中文翻译 (poor quality)*]
...
=== ROS Resources
. http://www.roseducation.org/[机器人操作系统（ROS）教育基金会] (!many videos and pdfs!]
...
- 《GB/T 30029 自动导引车（AGV） 设计通则》, http://www.std.gov.cn/gb/search/gbDetailed?id=71F772D7EC55D3A7E05397BE0A0AB82A[pdf], http://www.agvchina.com/index.aspx?lanmuid=93&sublanmuid=763&id=5[(alternative)]
- 《GB/T 30030 自动导引车（AGV） 术语》, http://www.std.gov.cn/gb/search/gbDetailed?id=71F772D7EC56D3A7E05397BE0A0AB82A[pdf],  http://www.agvchina.com/index.aspx?lanmuid=93&sublanmuid=763&id=6[(alternative)]

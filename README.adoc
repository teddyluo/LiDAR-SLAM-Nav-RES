...
== Project I: Hardware Configuration

. Laser: Osight LSXXX^TM^ laser sensor configuration & test: +
link:./notes/ROS_Osight_LSXXX.adoc[*configuration*]

. IMU: https://github.com/KristofRobot/razor_imu_9dof[Sparkfun 9DoF Razor IMU (MPU-9250)]

== Current Project: Motion Planning

=== Papers
. Kaiyu Zheng, https://github.com/zkytony/ROSNavigationGuide/blob/master/main.pdf[*_ROS Navigation Tuning Guide_*], 2016. https://blog.csdn.net/zong596568821xp/article/details/77934688[*中文翻译*]

. D. V. Lu, D. Hershberger and W. D. Smart, "*_Layered costmaps for context-sensitive navigation_*," 2014 IEEE/RSJ International Conference on Intelligent Robots and Systems, Chicago, IL, 2014, pp. 709-715.+
 ** http://wustl.probablydavid.com/publications/IROS2014.pdf[PDF],  https://scholar.google.com/citations?user=bfksbjAAAAAJ&hl=zh-CN[Google Scholar]
...
== Project II: Google Cartographer -- Laser-based SLAM
...
== Project II (con.):  LiDAR SLAM Survey
